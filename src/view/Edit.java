 ...
 * @author Lenovo
 */
public class Edit extends javax.swing.JFrame implements Runnable  {
     ...
     */
    public Edit(String role, String nim, String nama, String kelas) {
        this.nim = nim;
        this.role = role;
        this.kelas = kelas;
        this.nama = nama;
        ...
        pendaftaran.loadMemberData(nim, fieldNIM, fieldNama, fieldKelas);
    ...
    private void initComponents() {
        ...
        labelRegister.setText("UBAH  DATA");
    ...
    String nimBaru = fieldNIM.getText();
    Member member = new Member(nimBaru, nama, kelas, role);

    try {
            // melakukan update data member
            pendaftaran.updateMember(nim, member);
